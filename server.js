// server.js (GEMINI 1.5 PRO - YÜKSEK ZEKA MODU)
...
// Flash yerine "Pro" modelini seçtik. Bu model daha yavaş çalışır ama çok daha akıllıdır.
...
app.post('/api/analyze', async (req, res) => {
    try {
        ...
        console.log(`Gemini çalışıyor... (Model: gemini-1.5-pro - Yıl: ${currentYear})`);
